module Roadmap
  ...
  def get_checkpoint_id(roadmap_id, section_number,checkpoint_number)
  ...
  def get_checkpoint_by_index(roadmap_id, section_number,checkpoint_number)
    checkpoint_id = get_checkpoint_id(roadmap_id, section_number, checkpoint_number)
